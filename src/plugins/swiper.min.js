...
!(function () {
  ...
  var t = function (e, i) {
    ...
    function o (e, t) {
      var s = a(e.target)
      if (!s.is(t)) {
        if (typeof t === 'string') s = s.parents(t)
        else if (t.nodeType) {
          var i
          return (
    ...
    function l (e, a) {
      ...
      s.observe(e, {
        attributes: typeof a.attributes === 'undefined' || a.attributes,
        childList: typeof a.childList === 'undefined' || a.childList,
        characterData: typeof a.characterData === 'undefined' || a.characterData
      }),
      b.observers.push(s)
    }
    function p (e) {
      ...
      if (
        ...
        ((b.isHorizontal() && a === 39) || (!b.isHorizontal() && a === 40))
      ) {
        return !1
      }
      if (
        !b.params.allowSwipeToPrev &&
        ((b.isHorizontal() && a === 37) || (!b.isHorizontal() && a === 38))
      ) {
        return !1
      }
      if (
        ...
        if (a === 37 || a === 39 || a === 38 || a === 40) {
          ...
          if (
            ...
            b.container.parents('.' + b.params.slideActiveClass).length === 0
          ) {
            return
          }
        ...
        b.isHorizontal()
          ...
          ((a === 39 && !b.rtl) || (a === 37 && b.rtl)) && b.slideNext(),
          ((a === 37 && !b.rtl) || (a === 39 && b.rtl)) && b.slidePrev())
          : ((a !== 38 && a !== 40) ||
              (e.preventDefault ? e.preventDefault() : (e.returnValue = !1)),
          a === 40 && b.slideNext(),
          a === 38 && b.slidePrev())
    ...
    function d () {
      ...
      if (!a) {
        ...
        t.setAttribute(e, 'return;'), (a = typeof t[e] === 'function')
      }
      return (
        !a &&
    ...
    for (var w in i) {
      if (
        ...
        (i[w].nodeType ||
          i[w] === window ||
          i[w] === document ||
          (typeof s !== 'undefined' && i[w] instanceof s) ||
          (typeof jQuery !== 'undefined' && i[w] instanceof jQuery))
      ) {
        v[w] = i[w]
      } else {
        v[w] = {}
    ...
    for (var x in g) {
      if (typeof i[x] === 'undefined') i[x] = g[x]
      else if (typeof i[x] === 'object') {
        for (var T in g[x]) {
          typeof i[x][T] === 'undefined' && (i[x][T] = g[x][T])
        }
      }
    }
    var b = this
    if (
      ...
      (b.originalParams = v),
      (b.classNames = []),
      typeof a !== 'undefined' && typeof s !== 'undefined' && (a = s),
      (typeof a !== 'undefined' ||
        (a =
          typeof s === 'undefined'
          ...
          if (e && b.currentBreakpoint !== e) {
            var a =
              e in b.params.breakpoints
                ...
                : b.originalParams
            var t = b.params.loop && a.slidesPerView !== b.params.slidesPerView
      ...
      (b.params.effect !== 'fade' && b.params.effect !== 'flip') ||
          ((b.params.slidesPerView = 1),
          (b.params.slidesPerColumn = 1),
          (b.params.slidesPerGroup = 1),
          (b.params.watchSlidesProgress = !0),
          (b.params.spaceBetween = 0),
          (b.params.setWrapperSize = !1),
          typeof f === 'undefined' && (b.params.virtualTranslate = !0)),
      b.params.grabCursor && b.support.touch && (b.params.grabCursor = !1),
      (b.wrapper = b.container.children('.' + b.params.wrapperClass)),
      b.params.pagination &&
          ((b.paginationContainer = a(b.params.pagination)),
          b.params.uniqueNavElements &&
            typeof b.params.pagination === 'string' &&
            b.paginationContainer.length > 1 &&
            b.container.find(b.params.pagination).length === 1 &&
            (b.paginationContainer = b.container.find(b.params.pagination)),
          b.params.paginationType === 'bullets' && b.params.paginationClickable
      ...
      (b.params.nextButton || b.params.prevButton) &&
          (b.params.nextButton &&
            ...
            b.params.uniqueNavElements &&
              ...
              b.container.find(b.params.nextButton).length === 1 &&
              (b.nextButton = b.container.find(b.params.nextButton))),
          b.params.prevButton &&
            ((b.prevButton = a(b.params.prevButton)),
            b.params.uniqueNavElements &&
              typeof b.params.prevButton === 'string' &&
              b.prevButton.length > 1 &&
              b.container.find(b.params.prevButton).length === 1 &&
              (b.prevButton = b.container.find(b.params.prevButton)))),
      (b.isHorizontal = function () {
        return b.params.direction === 'horizontal'
      }),
      (b.rtl =
          b.isHorizontal() &&
          (b.container[0].dir.toLowerCase() === 'rtl' ||
            b.container.css('direction') === 'rtl')),
      b.rtl && b.classNames.push(b.params.containerModifierClass + 'rtl'),
      b.rtl && (b.wrongRTL = b.wrapper.css('display') === '-webkit-box'),
      b.params.slidesPerColumn > 1 &&
      ...
      (b.startAutoplay = function () {
        return (
          typeof b.autoplayTimeoutId === 'undefined' &&
            (!!b.params.autoplay &&
              (!b.autoplaying &&
      ...
      (b.updateAutoHeight = function () {
        ...
        var a = []
        var t = 0
        if (b.params.slidesPerView !== 'auto' && b.params.slidesPerView > 1) {
      ...
      (b.updateContainerSize = function () {
        var e, a
          ;(e =
            typeof b.params.width !== 'undefined'
              ? b.params.width
              : b.container[0].clientWidth),
        (a =
              typeof b.params.height !== 'undefined'
                ? b.params.height
      ...
      (b.updateSlidesSize = function () {
        ...
        (b.slidesSizesGrid = [])
        var e
        var a = b.params.spaceBetween
        var t = -b.params.slidesOffsetBefore
        var s = 0
        var i = 0
        if (typeof b.size !== 'undefined') {
          ...
          b.params.slidesPerColumn > 1 &&
              ...
              b.params.slidesPerView !== 'auto' &&
                b.params.slidesPerColumnFill === 'row' &&
                (n = Math.max(
                  n,
                  b.params.slidesPerView * b.params.slidesPerColumn
                )))
          var o
          var l = b.params.slidesPerColumn
          var p = n / l
          var d = p - (b.params.slidesPerColumn * p - b.slides.length)
          for (e = 0; e < b.slides.length; e++) {
            o = 0
            var u = b.slides.eq(e)
            if (b.params.slidesPerColumn > 1) {
              var c, m, h
              b.params.slidesPerColumnFill === 'column'
                ? ((m = Math.floor(e / l)),
                (h = e - m * l),
                (m > d || (m === d && h === l - 1)) &&
                      ++h >= l &&
          ...
          b.snapGrid.length === 0 && (b.snapGrid = [0]),
          b.params.spaceBetween !== 0 &&
                (b.isHorizontal()
                  ? b.rtl
      ...
      (b.currentSlidesPerView = function () {
        ...
        if (b.params.centeredSlides) {
          var s
          var i = b.slides[b.activeIndex].swiperSlideSize
      ...
      (b.updateSlidesProgress = function (e) {
        if (
          (typeof e === 'undefined' && (e = b.translate || 0),
          b.slides.length !== 0)
        ) {
          typeof b.slides[0].swiperSlideOffset === 'undefined' &&
      ...
      (b.updateActiveIndex = function () {
        ...
        var a
        var t
        var s = b.rtl ? b.translate : -b.translate
        for (a = 0; a < b.slidesGrid.length; a++) {
          typeof b.slidesGrid[a + 1] !== 'undefined'
            ? s >= b.slidesGrid[a] &&
                s <
                  b.slidesGrid[a + 1] -
        ...
        if (
          ...
          if (
            (b.params.loop
              ...
              r > n - 1 && (r -= n),
              r < 0 && b.params.paginationType !== 'bullets' && (r = n + r))
              : (r =
                    typeof b.snapIndex !== 'undefined'
                      ? b.snapIndex
                      : b.activeIndex || 0),
            b.params.paginationType === 'bullets' &&
                b.bullets &&
                b.bullets.length > 0 &&
            ...
            b.params.paginationType === 'fraction' &&
                ...
                b.paginationContainer
                  ...
                  .text(n)),
            b.params.paginationType === 'progress')
          ) {
            var o = (r + 1) / n
            var l = o
            var p = 1
          ...
          b.params.paginationType === 'custom' &&
      ...
      (b.updatePagination = function () {
        if (
          ...
          var e = ''
          if (b.params.paginationType === 'bullets') {
            for (
              var a = b.params.loop
                  ? Math.ceil(
                    (b.slides.length - 2 * b.loopedSlides) /
      ...
      (b.onResize = function (e) {
        ...
        var t = b.params.allowSwipeToNext
          ;(b.params.allowSwipeToPrev = b.params.allowSwipeToNext = !0),
        b.updateContainerSize(),
        b.updateSlidesSize(),
        (b.params.slidesPerView === 'auto' || b.params.freeMode || e) &&
              b.updatePagination(),
        b.params.scrollbar && b.scrollbar && b.scrollbar.set(),
        b.controller &&
              b.controller.spline &&
      ...
      (window.navigator.pointerEnabled ||
          window.navigator.msPointerEnabled) &&
          (b.params.touchEventsTarget === 'container'
            ? b.container
            : b.wrapper
      ...
      (b.initEvents = function (e) {
        ...
        var s =
            b.params.touchEventsTarget === 'container'
              ? b.container[0]
              : b.wrapper[0]
        var r = b.support.touch ? s : document
        var n = !!b.params.nested
        if (b.browser.ie) {
          ...
          if (b.support.touch) {
            var o = !(
              b.touchEvents.start !== 'touchstart' ||
      ...
      var D
      var B
      var H = 'input, select, textarea, button, video'
      var G = Date.now()
      var X = []
      ;(b.animating = !1),
      (b.touches = {
            ...
            if (
              ...
              if (A || !b.browser.ieTouch) {
                ...
                if (
                  ...
                  !b.params.allowSwipeToNext &&
                      b.swipeDirection === 'next' &&
                      I < k &&
                      (I = k),
                  !b.params.allowSwipeToPrev &&
                      b.swipeDirection === 'prev' &&
                      I > k &&
                      (I = k),
                ...
                b.params.followFinger &&
                    ...
                    b.params.freeMode &&
                      ...
                      X.push({
                        position:
                          b.touches[b.isHorizontal() ? 'currentX' : 'currentY'],
      ...
      (b.onTouchEnd = function (e) {
        if (
          ...
          if (
            ...
            !C || !z || !b.swipeDirection || b.touches.diff === 0 || I === k)
          ) {
            return void (C = z = !1)
          }
          C = z = !1
            ...
            if (b.params.freeModeMomentum) {
              ...
              if (u < b.maxTranslate()) {
                b.params.freeModeMomentumBounce
                  ? (u + b.maxTranslate() < -h && (u = b.maxTranslate() - h),
                  (c = b.maxTranslate()),
                  (m = !0),
                  (B = !0))
                  : (u = b.maxTranslate())
          ...
          var v
          var w = 0
          var y = b.slidesSizesGrid[0]
          for (v = 0; v < b.slidesGrid.length; v += b.params.slidesPerGroup) {
            typeof b.slidesGrid[v + b.params.slidesPerGroup] !== 'undefined'
              ? i >= b.slidesGrid[v] &&
          ...
          if (s > b.params.longSwipesMs) {
            ...
            b.swipeDirection === 'next' &&
                b.slideTo(w + b.params.slidesPerGroup),
            b.swipeDirection === 'prev' && b.slideTo(w)
          }
        }
      }),
        ...
        return (
          !(
            ...
            (!(
              ...
              (typeof a === 'undefined' && (a = b.params.speed),
              ...
              (b.rtl && -i === b.translate) || (!b.rtl && i === b.translate)
                ? (b.params.autoHeight && b.updateAutoHeight(),
                b.updateClasses(),
                b.params.effect !== 'slide' && b.setWrapperTranslate(i),
                !1)
                : (b.updateClasses(),
                b.onTransitionStart(t),
                a === 0 || b.browser.lteIE9
                  ? (b.setWrapperTranslate(i),
                  b.setWrapperTransition(0),
                  b.onTransitionEnd(t))
                  : (b.setWrapperTranslate(i),
      ...
      (b.setWrapperTranslate = function (e, a, t) {
        ...
        var o
        var l = b.maxTranslate() - b.minTranslate()
          ;(o = l === 0 ? 0 : (e - b.minTranslate()) / l),
            ...
            window.WebKitCSSMatrix
              ...
              s.split(',').length > 6 &&
                      (s = s
                        ...
                        .join(', ')),
              (r = new window.WebKitCSSMatrix(s === 'none' ? '' : s)))
              : ((r =
                      i.MozTransform ||
                      i.OTransform ||
                      i.MsTransform ||
      ...
      (b.getWrapperTranslate = function (e) {
        return (
          typeof e === 'undefined' && (e = b.isHorizontal() ? 'x' : 'y'),
      ...
      (b.effects = {
        fade: {
          ...
          setTransition: function (e) {
            if (
              (b.slides.transition(e), b.params.virtualTranslate && e !== 0)
            ) {
              var a = !1
          ...
          setTranslate: function () {
            ...
            if (
              ...
              if (b.isHorizontal()) {
                ...
                var f = b.params.cube.shadowScale
                var v = b.params.cube.shadowScale / g
                var w = b.params.cube.shadowOffset
                e.transform(
                  'scale3d(' +
                      f +
                      ', 1, ' +
        ...
        coverflow: {
          setTranslate: function () {
            for (
              ...
              var o = b.slides.eq(r)
              var l = b.slidesSizesGrid[r]
              var p = o[0].swiperSlideOffset
              var d = ((t - p - l / 2) / l) * b.params.coverflow.modifier
              var u = b.isHorizontal() ? s * d : 0
              var c = b.isHorizontal() ? 0 : s * d
              var m = -i * Math.abs(d)
              var h = b.isHorizontal() ? 0 : b.params.coverflow.stretch * d
              var g = b.isHorizontal() ? b.params.coverflow.stretch * d : 0
      ...
      (b.lazy = {
        ...
        loadImageInSlide: function (e, t) {
          if (
            typeof e !== 'undefined' &&
              (typeof t === 'undefined' && (t = !0), b.slides.length !== 0)
          ) {
            var s = b.slides.eq(e)
            var i = s.find(
              '.' +
            ...
            i.length !== 0 &&
                  i.each(function () {
                    ...
                    var r = e.attr('data-src')
                    var n = e.attr('data-srcset')
                    var o = e.attr('data-sizes')
                    b.loadImage(e[0], r || i, n, o, !1, function () {
                      if (
                        (i
                          ...
                          o &&
                              (e.attr('sizes', o), e.removeAttr('data-sizes')),
        ...
        load: function () {
          ...
          if (b.params.lazyLoadingInPrevNext) {
            if (
              ...
              var n = Math.max(b.activeIndex - Math.max(i, s), 0)
      ...
      (b.scrollbar = {
        ...
        setDragPosition: function (e) {
          ...
          var s =
              ...
              a.dragSize / 2
          var i = -b.minTranslate() * a.moveDivider
          var r = -b.maxTranslate() * a.moveDivider
          s < i ? (s = i) : s > r && (s = r),
          (s = -s / a.moveDivider),
          b.updateProgress(s),
        ...
        enableDraggable: function () {
          var e = b.scrollbar
          var t = b.support.touch ? e.track : document
        ...
        set: function () {
          if (b.params.scrollbar) {
            ...
            b.params.uniqueNavElements &&
                  typeof b.params.scrollbar === 'string' &&
                  e.track.length > 1 &&
                  b.container.find(b.params.scrollbar).length === 1 &&
        ...
        setTranslate: function () {
          if (b.params.scrollbar) {
            var e
            var a = b.scrollbar
            var t = (b.translate || 0, a.dragSize)
      ...
      (b.controller = {
        ...
        setTranslate: function (e, a) {
          function s (a) {
            ;(e =
                a.rtl && a.params.direction === 'horizontal'
                  ? -b.translate
                  : b.translate),
            b.params.controlBy === 'slide' &&
                  (b.controller.getInterpolateFunction(a),
                  (r = -b.controller.spline.interpolate(-e))),
            (r && b.params.controlBy !== 'container') ||
                  ((i =
      ...
      (b.hashnav = {
        onHashCange: function (e, a) {
          ...
          var s = b.slides.eq(b.activeIndex).attr('data-hash')
          t !== s &&
              b.slideTo(
                b.wrapper
                  .children(
        ...
        setHash: function () {
          if (b.hashnav.initialized && b.params.hashnav) {
            if (
              ...
              var e = b.slides.eq(b.activeIndex)
              var a = e.attr('data-hash') || e.attr('data-history')
      ...
      (b.history = {
        ...
        setHistory: function (e, a) {
          if (b.history.initialized && b.params.history) {
            var t = b.slides.eq(a)
            var s = this.slugify(t.attr('data-history'))
        ...
        scrollToSlide: function (e, a, t) {
          if (a) {
            for (var s = 0, i = b.slides.length; s < i; s++) {
              var r = b.slides.eq(s)
              var n = this.slugify(r.attr('data-history'))
      ...
      (b.disableMousewheelControl = function () {
        ...
        var e = b.container
        return (
          b.params.mousewheelEventsTarged !== 'container' &&
      ...
      (b.parallax = {
        ...
        setTransition: function (e) {
          typeof e === 'undefined' && (e = b.params.speed),
          b.container
            .find(
              '[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]'
            )
            .each(function () {
              var t = a(this)
              var s =
                    parseInt(t.attr('data-swiper-parallax-duration'), 10) || e
              e === 0 && (s = 0), t.transition(s)
            })
        }
      }),
      (b.zoom = {
        ...
        getDistanceBetweenTouches: function (e) {
          ...
          var i = e.targetTouches[1].pageY
          var r = Math.sqrt(Math.pow(s - a, 2) + Math.pow(i - t, 2))
          return r
        },
          ...
          var a = b.zoom
            ;(!b.support.gestures &&
              ...
              (a.gesture.image &&
                ...
                (a.isScaling = !1),
                a.scale === 1 && (a.gesture.slide = void 0)))
        },
        onTouchStart: function (e, a) {
          var t = e.zoom
          t.gesture.image &&
              t.gesture.image.length !== 0 &&
              (t.image.isTouched ||
                (e.device.os === 'android' && a.preventDefault(),
                (t.image.isTouched = !0),
        ...
        onTouchEnd: function (e, a) {
          var t = e.zoom
          if (t.gesture.image && t.gesture.image.length !== 0) {
            ...
            var s = 300
            var i = 300
            var r = t.velocity.x * s
            var n = t.image.currentX + r
            var o = t.velocity.y * i
            var l = t.image.currentY + o
            t.velocity.x !== 0 &&
        ...
        toggleZoom: function (e, t) {
          ...
          if (
            ...
            s.gesture.image && s.gesture.image.length !== 0)
          ) {
            var i, r, n, o, l, p, d, u, c, m, h, g, f, v, w, y, x, T
            typeof s.image.touchesStart.x === 'undefined' && t
              ? ((i =
                    t.type === 'touchend'
      ...
      return (
        ...
        (b.off = function (e, a) {
          var t
          if (((e = h(e)), typeof a === 'undefined')) {
            return (b.emitterEventListeners[e] = []), b
          }
          if (
            b.emitterEventListeners[e] &&
            b.emitterEventListeners[e].length !== 0
          ) {
        ...
        (b.cleanupStyles = function () {
          ...
          b.bullets &&
              ...
              b.bullets.removeClass(b.params.bulletActiveClass),
          b.params.prevButton &&
              a(b.params.prevButton).removeClass(b.params.buttonDisabledClass),
          b.params.nextButton &&
              a(b.params.nextButton).removeClass(b.params.buttonDisabledClass),
          b.params.scrollbar &&
              b.scrollbar &&
              (b.scrollbar.track &&
    ...
    browser: {
      ...
      lteIE9: (function () {
        ...
        return (
          ...
          e.getElementsByTagName('i').length === 1
        )
      })()
    },
    device: (function () {
      ...
      var t = e.match(/(iPad).*OS\s([\d_]+)/)
      var s = e.match(/(iPod)(.*OS\s([\d_]+))?/)
      var i = !t && e.match(/(iPhone\sOS|iOS)\s([\d_]+)/)
          ...
          (e.prototype = {
            ...
            offset: function () {
              if (this.length > 0) {
                ...
                var t = document.body
                var s = e.clientTop || t.clientTop || 0
                var i = e.clientLeft || t.clientLeft || 0
                var r = window.pageYOffset || e.scrollTop
                var n = window.pageXOffset || e.scrollLeft
            ...
            insertBefore: function (e) {
              for (var t = a(e), s = 0; s < this.length; s++) {
                if (t.length === 1) t[0].parentNode.insertBefore(this[s], t[0])
                else if (t.length > 1) {
            ...
            children: function (t) {
              for (var s = [], i = 0; i < this.length; i++) {
                for (var r = this[i].childNodes, n = 0; n < r.length; n++) {
                  t
                    ? r[n].nodeType === 1 && a(r[n]).is(t) && s.push(r[n])
                    : r[n].nodeType === 1 && s.push(r[n])
                }
              }
